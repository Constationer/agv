        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Data Currency</h1>
                        <ol class="breadcrumb">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content rounded-modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title text-primary" id="newDataModalLabel">Add New Currency
                                            </h4>
                                            <button type="button" class="btn-close"
                                                data-bs-dismiss="modal">&times;</button>
                                        </div>
                                        <div class="modal-body" style="min-height: 500px;">
                                            <form action="{{ route('datacurrency.store') }}" method="post"
    ...
    <script>
        $(document).ready(function() {
            var table = $('#myDataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('datacurrency.getData') }}',
                columns: [{
                        data: null,
